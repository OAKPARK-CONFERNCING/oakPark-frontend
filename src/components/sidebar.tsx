...
function Sidebar({ children }: SidebarProps) {
    ...
    const navigationItems = [
      { id: 'dashboard', url:'/dashboard', label: 'Dashboard', icon: <Home size={20} /> },
        ...
        <div className="flex flex-row">
            <aside className="left w-[250px]">
                <div className="logo flex flex-row h-[70px] w-[249px] items-center border border-[#eeeeee]">
                    ...
                    <img src={videoIcon} alt="Video recording icon" width={20} height={20} className='' />
                    </div>
                    <span className="text-lg font-bold uppercase text-green-500 items-center">OakPark</span>
                </div>
          ...
          <header className='h-10  w-full bg-black'></header>
