...
const UserProfileCard: React.FC<UserProfileCardProps> = ({ isVisible, onClose, user }) => {
  ...
  return (
    <div className="fixed right-0 top-16 w-96 rounded-3xl shadow-2xl z-50 overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center pt-16 pb-6 px-6 bg-white">
        ...
        {/* Edit Profile Button */}
        <button className="mt-6 w-full py-3 bg-[#4CAF50] text-white rounded-2xl text-lg font-semibold hover:bg-[#43a047] transition"><Link to="/edit"> Edit your Profile</Link></button>
        {/* Footer */}
